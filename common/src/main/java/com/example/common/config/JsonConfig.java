...
public class JsonConfig {
	...
	public ObjectMapper getObjectMapper(){
		...
		// 指定时间格式化
		objectMapper.setDateFormat(new SimpleDateFormat(DatePattern.PURE_DATETIME_PATTERN));
		return objectMapper;
	}
	...
	public static class JacksonHttpMessageConverter extends MappingJackson2HttpMessageConverter {
